...
// Public
router.get('/public', (0, memoryCache_1.cacheMiddleware)(60), articleController_1.getPublicArticles);
router.get('/public/:slug/related', (0, memoryCache_1.cacheMiddleware)(60), articleController_1.getRelatedContent);
router.get('/public/:slug', (0, memoryCache_1.cacheMiddleware)(60), articleController_1.getPublicArticleBySlug);
