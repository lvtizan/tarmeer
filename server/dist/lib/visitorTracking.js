...
exports.formatVisitorLocation = formatVisitorLocation;
exports.sanitizePagePath = sanitizePagePath;
...
function formatVisitorLocation(req) {
    const country = (typeof req.headers['cf-ipcountry'] === 'string' && req.headers['cf-ipcountry']) ||
        ...
        '';
    const region = (typeof req.headers['x-vercel-ip-country-region'] === 'string' && req.headers['x-vercel-ip-country-region']) ||
        (typeof req.headers['x-region'] === 'string' && req.headers['x-region']) ||
        '';
    const city = (typeof req.headers['x-vercel-ip-city'] === 'string' && req.headers['x-vercel-ip-city']) ||
...
function sanitizePagePath(rawPath) {
