...
exports.SPACE_L2_MAP = void 0;
exports.buildPublicCompaniesListQuery = buildPublicCompaniesListQuery;
exports.buildPublicCompanyDetailQuery = buildPublicCompanyDetailQuery;
...
exports.SPACE_L2_MAP = SPACE_L2_MAP;
function buildPublicCompaniesListQuery(input) {
    ...
    const spaceWhere = input.spaceTags && input.spaceTags.length > 0
        ...
        : '';
    const country = input.country || 'ae';
    const params = [];
...
function buildPublicCompanyDetailQuery(slug) {
    return {
        sql: `SELECT
         uae_companies.id,
         uae_companies.slug,
