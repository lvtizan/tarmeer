...
import { getDesignerBySlug, getDesignerProjects } from '../data/designers';
        ...
        <main className="p-6 sm:p-8 lg:p-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6">
            {projects.map((project) => (
              <Link
                ...
                className="group block aspect-[4/3] overflow-hidden rounded-xl bg-stone-200 transition-transform duration-200 hover:-translate-y-1 relative"
              >
                <img
          ...
          <div className="mt-12 pt-8 border-t border-stone-200 text-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="btn-primary px-8 py-4 text-sm uppercase tracking-wider"
            >
              Work with {designer.firstName}
            </a>
          </div>
