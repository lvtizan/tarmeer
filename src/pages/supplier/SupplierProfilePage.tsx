  ...
  return (
    <>
      ...
      <div className="max-w-2xl space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-stone-200 p-5 sm:p-6 space-y-4">
          <div>
            <h2 className="text-[15px] font-semibold text-[#2c2c2c]">Business License</h2>
            <p className="text-sm text-stone-500 mt-1">Upload your trade license to Google Drive or Dropbox and paste the shared link below.</p>
          </div>
          <div>
            <label className={labelCls}>License Document URL</label>
        ...
        {msg && (
          <p className={`text-sm px-4 py-3 rounded-2xl ${
            msg.includes('saved') ? 'bg-emerald-50 text-emerald-700' : 'bg-red-50 text-red-600'
          }`}>{msg}</p>
        )}
