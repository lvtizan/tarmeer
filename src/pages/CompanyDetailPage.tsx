...
import { ArrowLeft, Globe, Instagram, MapPin, Briefcase, ExternalLink, Calendar, FolderOpen } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#faf9f7]">
      ...
      <section className="relative">
        ...
        {/* Company Header Card - overlapping hero */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 border border-stone-100">
              {company.description && (
                <p className="text-[#44403c] leading-relaxed mb-5">{company.description}</p>
              )}
            ...
            {/* Portfolio placeholder - rendered full width below */}
          </div>
            ...
            <div className="lg:sticky lg:top-20 space-y-4">
              {(company.website || company.instagram) && (
                <div className="bg-white rounded-2xl p-6 border border-stone-100">
                  <h3 className="font-serif text-lg font-semibold text-[#1c1917] mb-5">Links</h3>
