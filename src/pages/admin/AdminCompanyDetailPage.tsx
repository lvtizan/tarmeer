      ...
      <div className="flex gap-6 items-start">
        ...
        <div className="w-80 flex-shrink-0 space-y-4">
          ...
          <div className="bg-white rounded-xl border border-stone-200 p-5 space-y-2.5 text-sm">
            ...
            {company.instagram && <InfoRow label="Instagram" value={company.instagram} />}
            {company.facebook && <InfoRow label="Facebook" value={company.facebook} />}
            {company.linkedin && <InfoRow label="LinkedIn" value={company.linkedin} />}
          </div>
