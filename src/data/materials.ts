...
const caseStudiesByCategory: Record<string, MaterialCaseStudy[]> = {
  ...
  'hard-materials': [
    { id: 1, title: 'Palm Jumeirah Villa Flooring', location: 'Palm Jumeirah', category: 'Premium Stone', image: 'https://images.unsplash.com/photo-1600607687644-c7171b42498b?w=800&q=85', description: 'Imported Italian marble with custom patterns and inlay work.', features: ['Italian marble', 'Custom patterns', 'Honed finish', 'Sealing treatment'] },
    { id: 2, title: 'Downtown Apartment Tiling', location: 'Downtown Dubai', category: 'Premium Tiles', image: 'https://images.unsplash.com/photo-1600566752355-35792bedcfea?w=800&q=85', description: 'Large format porcelain tiles with minimal grout lines for seamless look.', features: ['Large format tiles', 'Minimal grout', 'Polished finish', 'Anti-slip treatment'] },
  ...
  'smart-tech': [
    ...
    { id: 6, title: 'Jumeirah Smart Home Integration', location: 'Jumeirah', category: 'Full Home Automation', image: 'https://images.unsplash.com/photo-1558002038-1091a1661116?w=800&q=85', description: 'Comprehensive smart home system with centralized control of all functions.', features: ['Central hub', 'Multi-room audio', 'Security cameras', 'Energy management'] },
  ],
};
