...
export default function AdminGlobalSearch() {
  ...
  const navigateTo = useCallback((r: FlatResult) => {
    ...
    else if (r.kind === 'registeredCompany') navigate(`/admin/companies?tab=companies&search=${encodeURIComponent(r.item.name)}`);
    else if (r.kind === 'directoryCompany') navigate(`/admin/companies?tab=directory&search=${encodeURIComponent(r.item.name)}`);
