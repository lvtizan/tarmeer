    ...
    <div dir={lang === 'ar' ? 'rtl' : 'ltr'}>
      ...
      <section className="bg-[#141211] relative overflow-hidden">
        ...
        <div className="absolute top-4 right-4 z-10 flex items-center gap-1 rounded-lg border border-white/20 p-0.5">
          <button
            onClick={() => setLang('en')}
            className={`px-3 py-1 text-sm font-medium rounded-md transition ${lang === 'en' ? 'bg-[#b8864a] text-white' : 'text-white/60'}`}
          >
            EN
          </button>
          <button
      ...
      <section className="bg-[#f5f0e8] py-14 lg:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
            ...
            {([
              { icon: Search, step: '01', tag: 'feature1Tag' as const, title: 'feature1Title' as const, desc: 'feature1Desc' as const, checks: ['feature1Check1', 'feature1Check2', 'feature1Check3'] as const },
              { icon: Camera, step: '02', tag: 'feature2Tag' as const, title: 'feature2Title' as const, desc: 'feature2Desc' as const, checks: ['feature2Check1', 'feature2Check2', 'feature2Check3'] as const },
              { icon: Phone, step: '03', tag: 'feature3Tag' as const, title: 'feature3Title' as const, desc: 'feature3Desc' as const, checks: ['feature3Check1', 'feature3Check2', 'feature3Check3'] as const },
            ]).map((feat) => (
