...
import { GOOGLE_MAPS_URL, ADDRESS, INSTAGRAM_URL, VN_ADDRESS, VN_GOOGLE_MAPS_URL, VN_WHATSAPP_NUMBERS } from '../lib/constants';
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-[auto_auto_auto_1fr_auto] gap-8 lg:gap-10">
          ...
          <div>
            ...
            <p className="text-sm text-white/80 flex items-start gap-2">
              ...
              <span>{lang === 'vi' ? VN_ADDRESS : ADDRESS}</span>
            </p>
            <a
              href={lang === 'vi' ? VN_GOOGLE_MAPS_URL : GOOGLE_MAPS_URL}
              target="_blank"
          ...
          <div>
            ...
            {lang === 'vi' ? (
              VN_WHATSAPP_NUMBERS.map(({ label, link }) => (
                <a
                  key={link}
                  href={link}
                  target="_blank"
