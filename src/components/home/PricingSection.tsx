import { Building2, LampFloor, PencilRuler } from 'lucide-react';
            ...
            >
              <div className="flex flex-1 flex-col p-5 sm:p-6">
                <div className="mb-4 flex items-center gap-3">
                  <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-[#c6a065]/30 bg-[#c6a065]/10 text-[#b8864a]">
                    <pkg.icon className="h-5 w-5" strokeWidth={1.8} />
                  </div>
